...
3. Sort 'new_examples' based on distinctiveness or complexity of transformation logic

4. If the length of 'prompt_examples' is less than 5:
    - Add the most distinctive examples from 'new_examples' to 'prompt_examples' until it contains 5 examples (MMR Algorithm)
Else:
